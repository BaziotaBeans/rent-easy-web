...
export function SchedulingCard({ data }:SchedulingCardProps) {
  return (
    <SchedulingDetailSheet data={data}>
      <Card className="flex flex-col sm:flex-row items-center gap-6 p-4 shadow-none transition-all cursor-pointer hover:bg-zinc-50 hover:border-primary-base hover:bg-primary-base/5">
        ...
        <span className="sm:ml-auto text-primary-base font-semibold text-base px-4">
          Ver detalhes
        </span>
      </Card>
