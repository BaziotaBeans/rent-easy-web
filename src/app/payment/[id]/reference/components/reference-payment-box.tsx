...
interface ReferencePaymentBoxProps {
  data: OrderResponse;
}

export function ReferencePaymentBox({ data }: ReferencePaymentBoxProps) {
  ...
  return (
    <div className="bg-white max-w-[500px] w-full rounded-2xl p-6 flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        <Button variant={"primary"} className="font-bold" asChild>
          <Link href="/myrenteasy/orders">Ir para pedidos</Link>
        </Button>
        <Button
          variant={"ghost"}
