  ...
  return (
    <Dialog.Root open={isOpen}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed overflow-y-auto left-[50%] top-[50%] flex-col min-h-screen h-full z-50 w-full max-w-[1024px] translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%]">
          <PropertyDetailDialogHeader />
          <Dialog.Title className="sr-only">Detalhes do imóvel</Dialog.Title>

          <>
            <Dialog.Description className="sr-only">Detalhes do imóvel</Dialog.Description>
            <PropertyListing
              data={data}
            />
          </>
